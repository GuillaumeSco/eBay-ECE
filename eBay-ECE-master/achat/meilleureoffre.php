		...
		<lu class="item_list">
			<li class="item">
				<div class="col-sm-12">
					...
					<div class="app-title">
						<h2>Items vente à la meilleure offre</h2>
					</div>
					...
					<div class="login">
						<div class="login-screen">
							<div class="middle">	
								...
								if ($db_found) {
								$sql = "SELECT ID_item FROM Item WHERE achete = '0' AND vente_item = 'vente par meilleure offre' ";
							...
							echo "<form action=acheter_meilleure_offre.php method=post>";
								echo "<table>";
									echo "<tr>";
										//	echo " <td><input type=radio name=suppr value=". $data['ID_item'] . ">";
											...
											echo "<td>ID item : " . $data['ID_item'] ;
												...
												echo"<td><input class=btn btn-primary btn-large btn-block type=submit name=button5 value=Achetez-le maintenant>". "<br>";
												echo "</tr>";
