					...
					<div class="col-sm-2">
						<li class="titre">
							...
							<ul class="sous_menu">
								...
								<li><a href="achatimmediat.php">Achetez-le maintenant <i class="fas fa-cash-register"></i></a></li>
...
//connectez-vous de votre BDD
								...
								if ($db_found) {
									...
									//exit();
										...
										while ($data = mysqli_fetch_assoc($result)) {	
											...
											echo "<table>";
											echo "<tr>";
											echo " <td><input type=radio name=suppr value=". $data['Nom_item'] . ">";
											//	"<label for=". $data['ID_item'] . "> ". $data['ID_item'] . "</label>";
											echo "Nom de l'item : " . $data['Nom_item'] . "<br>";
											echo "</tr>";
											//echo "Photo de profil :". "<img src=".$data['Photo']." />" . "<br>";
							...
							<div class="right">	
								<p>prix :</p><br>
								<input class="btn btn-primary btn-large btn-block" type="submit" name="button1" value="ENCHÉRIR!">
								<input class="btn btn-primary btn-large btn-block" type="submit" name="button1" value="Achetez-le maintenant">
