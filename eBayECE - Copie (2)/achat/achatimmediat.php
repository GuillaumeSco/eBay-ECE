...
//connectez-vous de votre BDD
								...
								if ($db_found) {
									$sql = "SELECT * FROM Item WHERE achete = '0' AND achat_imm_item = '1'";
									...
									//exit();
										...
										//	echo " <td><input type=radio name=suppr value=". $data['ID_item'] . ">";
											...
											echo"<br><input class=btn btn-primary btn-large btn-block type=submit name=button5 value=Achetez-le maintenant>" . "<br>";
