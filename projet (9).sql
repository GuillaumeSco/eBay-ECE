...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  sam. 18 avr. 2020 à 17:41
...
(112, 'accessoire VIP', 's', 's', 's', 'sfdg', 560, 'vente par meilleure offre', 1, 0, 2);
...
INSERT INTO `meilleure_offre` (`ID_m_offre`, `Prix_acheteur`, `Decompte`, `en_cours_vendeur`, `ID_acheteur`, `ID_vendeur`, `ID_item`) VALUES
(10, 18, 0, 2, 29, 2, 112);
...
(8, 'e', 4, 'e', 4, 'e', 4, '2020-04-09', 4, 455.25, 28),
(9, 'p', 8, 'p', 8, 'p', 8, '2020-04-04', 8, 337.68, 29),
